// Generates Unicode emoji flag from ISO 3166-1 alpha-2 code
export const flag = code =>
  String.fromCodePoint(...[...code.toUpperCase().slice(0, 2)].map(c => 0x1F1E6 + c.charCodeAt(0) - 65))

// France first, then sorted by French name
export const COUNTRIES = [
  ...
  { code: 'DO', name: 'Rép. dominicaine',                dial: '+1809' },
  { code: 'CZ', name: 'Rép. tchèque',                    dial: '+420'  },
  ...
  { code: 'VC', name: 'Saint-Vincent-et-Grenadines',     dial: '+1784' },
